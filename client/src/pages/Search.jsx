...
export default function Search() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      setSidebardata({
        ...
        isLand: isLandFromUrl === 'true' ? true : false,
  ...
  const handleSubmit = (e) => {
    ...
    urlParams.set('isLand', sidebardata.isLand);
        ...
        <div className='p-7'>
          {!loading && listings.length === 0 && (
            <div className='text-center py-12'>
              <p className='text-2xl text-slate-700 mb-4'>No properties found!</p>
              <p className='text-slate-500'>Try adjusting your search filters</p>
            </div>
          )}
          {loading && (
            <div className='text-center py-12'>
              <p className='text-xl text-slate-700'>Loading properties...</p>
            </div>
          )}
